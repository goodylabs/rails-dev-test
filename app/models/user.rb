class User < ApplicationRecord
  ...
  def credit_card_has_proper_format
    credit_card_regexes = [
      ...
      /^(4903|4905|4911|4936|6333|6759)[0-9]{12}|(4903|4905|4911|4936|6333|6759)[0-9]{14}|(4903|4905|4911|4936|6333|6759)
      [0-9]{15}|564182[0-9]{10}|564182[0-9]{12}|564182[0-9]{13}|633110[0-9]{10}|633110[0-9]{12}|633110[0-9]{13}$/x,
      /^(62[0-9]{14,17})$/,
      /^4[0-9]{12}(?:[0-9]{3})?$/,
      /^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14})$/
    ]
    credit_card_regexes.each do |credit_card_regex|
      return true if credit_card.blank? || credit_card.tr(',', '').tr('-', '').match(credit_card_regex)
    end
